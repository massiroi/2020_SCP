...
class DeployTask {
  ...
  synchronize () {
    ...
    if (singleDeleteCallsForDirectories) {
      ...
      tasks.push((callback) => this.container.delete(folders, parameters, hdi_callback(this.logger, callback, 'DELETE')));
    }
    ...
    tasks.push((callback) => this.container.write(this.deployContent, null, hdi_callback(this.logger, callback, 'WRITE')));
